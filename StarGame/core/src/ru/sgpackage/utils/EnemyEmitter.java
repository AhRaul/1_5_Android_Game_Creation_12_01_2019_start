...
public class EnemyEmitter {
    ...
    private static final float ENEMY_SMALL_BULLET_HEIGHT = 0.015f;    //размер пули маленького корабля
    private static final float ENEMY_SMALL_BULLET_VY = -0.6f;    //скорость и направление маленькой пули
    private static final int ENEMY_SMALL_DAMAGE = 1;    //урон маленькой пули
    private static final float ENEMY_SMALL_RELOAD_INTERVAL = 1.5f;    //перезарядка малой пули
    ...
    private static final float ENEMY_MIDDLE_BULLET_VY = -0.5f;    //скорость и направление средней пули
    private static final int ENEMY_MIDDLE_DAMAGE = 3;
    private static final float ENEMY_MIDDLE_RELOAD_INTERVAL = 2f;   //перезарядка средней пули
    ...
    private static final float ENEMY_BIG_BULLET_VY = -0.4f;    //скорость и направление большой пули
    private static final int ENEMY_BIG_DAMAGE = 5;
    private static final float ENEMY_BIG_RELOAD_INTERVAL = 2.5f;      //перезарядка большой пули
    private static final int ENEMY_BIG_HP = 5;

    private Vector2 enemySmallV = new Vector2(0, -0.25f);        //вектор скорости движения малого корабля
    ...
    public void generate(float delta, int frags) {
        level = frags / 10 + 1;
        generateInterval = 3f - level/5f;               //изменение скорости генерации противников с лвлом
        generateTimer += delta;
        if(generateTimer >= generateInterval) {
            ...
            if(randomEnemy<50) {                                    //вероятность появления малого корабля 50%
                enemy.set(
                        ...
                        ENEMY_SMALL_BULLET_VY - level/100f,
                        ENEMY_SMALL_DAMAGE * level,         // урон увеличивается с каждым уровнем
                        ENEMY_SMALL_RELOAD_INTERVAL- level/100f,
                        ENEMY_SMALL_HEIGHT,
                        ENEMY_SMALL_HP,
                        worldBounds
                );
                ...
                enemy.set(
                        ...
                        ENEMY_MIDDLE_BULLET_VY - level/100f,
                        ENEMY_MIDDLE_DAMAGE * level,
                        ENEMY_MIDDLE_RELOAD_INTERVAL - level/100f,
                        ENEMY_MIDDLE_HEIGHT,
                        ENEMY_MIDDLE_HP,
                        worldBounds
                );
                ...
                enemy.set(
                        ...
                        ENEMY_BIG_BULLET_VY - level/100f,
                        ENEMY_BIG_DAMAGE * level,
                        ENEMY_BIG_RELOAD_INTERVAL - level/100f,
                        ENEMY_BIG_HEIGHT,
                        ENEMY_BIG_HP,
                        worldBounds
                );
